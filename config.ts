...
export const AI_NAME = "Assura";
export const OWNER_NAME = "Kashish Panjwani";

export const WELCOME_MESSAGE = `Hello! I'm ${Assura}, an AI assistant created by ${Kashish_Panjwani}.`
